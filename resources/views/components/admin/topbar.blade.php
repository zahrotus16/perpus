    ...
    <div class="flex items-center gap-4">
        ...
        <div class="relative" id="notificationDropdown">
            ...
            <div id="notifMenu" class="hidden absolute right-0 mt-3 w-80 bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden dropdown-animate z-[60]">
                ...
                <a href="{{ route('admin.loans.index') }}" class="block py-3 text-center text-[10px] font-bold text-[#00bcd4] hover:bg-[#00bcd4]/5 transition-colors uppercase tracking-widest border-t border-slate-50">
                    View All Activities
                </a>
            </div>
        </div>
        ...
        <div class="relative group">
            ...
            <div id="quickActionMenu" class="hidden absolute right-0 mt-3 w-52 bg-white rounded-2xl shadow-2xl border border-slate-100 p-2 z-[60] dropdown-animate">
                ...
                <a href="{{ route('admin.books.create') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-[13px] font-medium text-slate-600 hover:bg-slate-50 hover:text-[#00bcd4] transition-colors">
                    <i class="fas fa-book w-5 opacity-50"></i> New Book
                </a>
                <a href="{{ route('admin.users.create') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-[13px] font-medium text-slate-600 hover:bg-slate-50 hover:text-[#00bcd4] transition-colors">
                    <i class="fas fa-user-plus w-5 opacity-50"></i> Anggota Baru
                </a>
                <a href="{{ route('admin.loans.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-[13px] font-medium text-slate-600 hover:bg-slate-50 hover:text-[#00bcd4] transition-colors">
