...
<?php $__env->startSection('page-title', 'Pengembalian Koleksi'); ?>
<?php $__env->startSection('page-subtitle', 'Kembalikan buku yang sedang Anda pinjam saat ini'); ?>
        ...
        <div class="bg-white dark:bg-dark-card rounded-2xl shadow-sm border border-slate-100 dark:border-dark-border/20 p-6 flex gap-6 transition-all hover:shadow-xl group">
            ...
            <div class="flex-1 flex flex-col">
                ...
                <div class="mt-4 pt-4 border-t border-slate-50 dark:border-dark-border/10 space-y-2">
                    ...
                    <?php if($loan->status !== 'pending'): ?>
                    <form action="<?php echo e(route('user.loans.return', $loan)); ?>" method="POST" class="mt-4 w-full">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\perpustakaan-digital\resources\views/user/loans/returns.blade.php ENDPATH**/ ?>