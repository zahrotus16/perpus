        ...
        <nav class="flex-1 flex flex-col gap-6">
            ...
            <div class="space-y-1">
                ...
                <a href="<?php echo e(route($item['route'])); ?>"
                    ...
                    <i class="fas <?php echo e($item['icon']); ?> text-xs w-5 text-center <?php echo e($isActive ? 'text-slate-900' : 'text-white/60 group-hover:text-white'); ?>"></i>
                    <span class="text-[11px] font-black uppercase tracking-wider"><?php echo e($item['name']); ?></span>
                    <?php if($isActive): ?>
...
</style><?php /**PATH D:\perpustakaan-digital\resources\views/components/admin/sidebar.blade.php ENDPATH**/ ?>