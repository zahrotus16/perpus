...
<?php $__env->startSection('page-title', 'Detail Koleksi'); ?>
<?php $__env->startSection('page-subtitle', 'Informasi lengkap dan ketersediaan buku'); ?>
...
<div x-data="{ showLoanModal: false }" class="max-w-5xl mx-auto space-y-6">
    ...
    <a href="<?php echo e(route('user.books.index')); ?>" class="inline-flex items-center gap-2 text-sm text-slate-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition font-bold uppercase tracking-widest text-[10px]">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-dark-card rounded-2xl shadow-xl dark:shadow-dark-soft border border-slate-100 dark:border-dark-border/20 overflow-hidden ring-4 ring-white dark:ring-dark shadow-2xl">
                <?php if($book->cover): ?>
                    <img src="<?php echo e(asset('storage/'.$book->cover)); ?>" alt="<?php echo e($book->title); ?>" class="w-full object-cover aspect-[3/4]">
                <?php else: ?>
                    <div class="w-full aspect-[3/4] flex flex-col items-center justify-center gap-4" style="background:linear-gradient(135deg,<?php echo e($book->category->color); ?>33,<?php echo e($book->category->color); ?>66)">
            ...
            <div class="space-y-3">
                ...
                <a href="<?php echo e(route('user.books.read', $book)); ?>"
                ...
                <?php if($userLoan): ?>
                    <div class="w-full flex flex-col items-center justify-center gap-1 bg-emerald-50 dark:bg-emerald-950/20 text-emerald-700 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-900/30 px-5 py-4 rounded-2xl text-xs font-black uppercase tracking-widest">
                        ...
                        <span class="text-[9px] opacity-70 font-bold italic lowercase italic tracking-normal">Batas Kembali: <?php echo e($userLoan->due_date->format('d M Y')); ?></span>
                    </div>
                <?php elseif(auth()->user()->activeLoans()->count() >= 3): ?>
                                ...
                                <div @click.away="showLoanModal = false" 
                                    ...
                                    <div class="p-10 text-center relative">
                                        ...
                                        <p class="text-xs font-medium text-slate-500 dark:text-gray-400 leading-relaxed mb-10 px-4">
                                            Anda akan meminjam <span class="font-black text-slate-800 dark:text-white">"<?php echo e($book->title); ?>"</span> dengan durasi standar <span class="font-black text-primary-600">7 Hari</span>. Pastikan Anda merawat koleksi ini dengan baik.
                                        </p>
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            ...
                                            <form action="<?php echo e(route('user.books.borrow', $book)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
            ...
            <div class="bg-white dark:bg-dark-card rounded-2xl shadow-sm dark:shadow-dark-soft border border-slate-100 dark:border-dark-border/20 p-6 space-y-4">
                ...
                <div class="flex justify-between items-center text-xs pb-3 border-b border-slate-50 dark:border-dark-border/10">
                    ...
                    <span class="font-black text-slate-800 dark:text-white uppercase tracking-tighter"><?php echo e($book->category->name); ?></span>
                </div>
                <div class="flex justify-between items-center text-xs pb-3 border-b border-slate-50 dark:border-dark-border/10">
                    <span class="font-bold text-slate-400 dark:text-gray-500 uppercase tracking-tighter">Tahun Rilis</span>
                    <span class="font-black text-slate-800 dark:text-white"><?php echo e($book->year ?: 'N/A'); ?></span>
                </div>
                <div class="flex justify-between items-center text-xs pb-3 border-b border-slate-50 dark:border-dark-border/10">
                    <span class="font-bold text-slate-400 dark:text-gray-500 uppercase tracking-tighter">Penerbit</span>
                    <span class="font-black text-slate-800 dark:text-white uppercase tracking-tighter"><?php echo e($book->publisher ?: 'N/A'); ?></span>
                </div>
                <div class="flex justify-between items-center text-xs pb-3 border-b border-slate-50 dark:border-dark-border/10">
                    <span class="font-bold text-slate-400 dark:text-gray-500 uppercase tracking-tighter">Ketebalan</span>
                    <span class="font-black text-slate-800 dark:text-white"><?php echo e($book->pages ?: '0'); ?> <span class="text-[9px] opacity-50">HAL</span></span>
                </div>
                <div class="flex justify-between items-center text-xs pb-3 border-b border-slate-50 dark:border-dark-border/10">
                    <span class="font-bold text-slate-400 dark:text-gray-500 uppercase tracking-tighter">Ketersediaan</span>
                    <span class="font-black <?php echo e($book->stock > 0 ? 'text-emerald-500' : 'text-red-500'); ?> uppercase"><?php echo e($book->stock > 0 ? $book->stock . ' Unit' : 'Kosong'); ?></span>
                </div>
                <div class="text-center pt-2">
                    <p class="text-[9px] font-black text-slate-300 dark:text-gray-700 uppercase tracking-[0.2em] font-mono"><?php echo e($book->isbn ?: 'No-ISBN-Recorded'); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-dark-card rounded-2xl shadow-sm dark:shadow-dark-soft border border-slate-100 dark:border-dark-border/20 p-8">
                <div class="flex flex-wrap items-center gap-3 mb-4">
                    ...
                    <div class="flex items-center gap-1.5 ml-auto">
                        <div class="flex gap-0.5">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                            <i class="fas fa-star text-[10px] <?php echo e($i <= round($book->rating) ? 'text-amber-400' : 'text-slate-200 dark:text-gray-800'); ?>"></i>
                            <?php endfor; ?>
                        </div>
                        <span class="text-xs font-black text-slate-800 dark:text-white"><?php echo e(number_format($book->rating,1)); ?></span>
                    </div>
                </div>

                <h1 class="text-3xl font-black text-slate-800 dark:text-white tracking-tight leading-tight mb-2"><?php echo e($book->title); ?></h1>
                <p class="text-slate-500 dark:text-gray-400 font-bold italic text-lg opacity-80 mb-6"><?php echo e($book->author); ?></p>
                ...
                <div class="flex items-center gap-6 py-4 border-y border-slate-50 dark:border-dark-border/10 text-xs font-black uppercase tracking-widest text-slate-400 dark:text-gray-600">
                    <div class="flex items-center gap-2">
                        ...
                        <span><?php echo e($book->views); ?> <span class="hidden sm:inline">Pembaca</span></span>
                    </div>
                    <div class="flex items-center gap-2">
                        <i class="fas fa-comment-alt text-emerald-500/50"></i>
                        <span><?php echo e($book->rating_count); ?> <span class="hidden sm:inline">Ulasan</span></span>
                    </div>
                    <?php if($book->pdf_file): ?>
                    <div class="flex items-center gap-2">
                    ...
                    <div class="relative flex items-center justify-between">
                        <div class="space-y-1">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h4 class="text-white text-xl font-black tracking-tight"><?php echo e($book->shelf_location); ?></h4>
                ...
                <div class="mt-8">
                    ...
                    <p class="text-sm text-slate-600 dark:text-gray-300 leading-loose text-justify italic">"<?php echo e($book->description); ?>"</p>
                </div>
                <?php endif; ?>
            </div>
                ...
                <div class="p-10">
                    ...
                    <div class="flex flex-col lg:flex-row gap-12 mb-16 items-center">
                        <div class="w-full lg:w-1/3 text-center lg:border-r border-slate-100 dark:border-dark-border/10 lg:pr-12">
                            <div class="text-7xl font-black text-slate-900 dark:text-white tracking-tighter mb-3"><?php echo e(number_format($book->rating, 1)); ?></div>
                            <div class="flex justify-center gap-1.5 mb-4">
                                <?php for($i=1;$i<=5;$i++): ?>
                                <i class="fas fa-star text-[16px] <?php echo e($i <= round($book->rating) ? 'text-amber-400' : 'text-slate-100 dark:text-gray-800'); ?>"></i>
                                <?php endfor; ?>
                            </div>
                            <p class="text-[10px] font-black text-slate-400 dark:text-gray-500 uppercase tracking-[0.3em] font-mono"><?php echo e($book->rating_count); ?> TOTAL ULASAN</p>
                        </div>
                        
                        <div class="w-full lg:w-2/3 space-y-4">
                            <?php $__currentLoopData = $starDistribution; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $star => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php 
                            ...
                            <div class="flex items-center gap-5 group">
                                <div class="flex items-center gap-1.5 w-12 flex-shrink-0">
                                    <span class="text-[10px] font-black text-slate-600 dark:text-gray-400"><?php echo e($star); ?></span>
                                ...
                                <div class="w-12 text-right">
                                    <span class="text-[10px] font-black text-slate-400 dark:text-gray-600"><?php echo e(number_format($percentage, 0)); ?>%</span>
                                </div>
                            </div>
                    ...
                    <div class="relative overflow-hidden group bg-white/40 dark:bg-dark-card/40 backdrop-blur-xl rounded-3xl p-8 mb-10 border border-white/50 dark:border-white/5 shadow-2xl transition-all hover:shadow-primary-500/10">
                        ...
                        <div class="relative">
                            ...
                            <form action="<?php echo e(route('user.books.review', $book)); ?>" method="POST" id="review-form">
                                <?php echo csrf_field(); ?>
                                <div class="flex items-center gap-6 mb-8">
                                    <div class="flex gap-1" id="star-rating-v2">
                                        ...
                                        <label class="relative cursor-pointer group/star">
                                            ...
                                            <i class="fas fa-star text-3xl text-slate-100 dark:text-gray-800 hover:scale-125 transition-all duration-300 star-icon-v2" data-val="<?php echo e($i); ?>"></i>
                                            <span class="absolute -bottom-6 left-1/2 -translate-x-1/2 text-[8px] font-black opacity-0 group-hover/star:opacity-100 transition-opacity text-primary-500"><?php echo e($i); ?></span>
                                        </label>
                                        <?php endfor; ?>
                                    </div>
                    ...
                    <div id="review-form-edit" class="hidden animate-fadeIn mb-10">
                         <form action="<?php echo e(route('user.books.review', $book)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="rating" value="<?php echo e($userReview->rating); ?>">
                            <textarea name="comment" rows="3" class="w-full px-5 py-4 bg-white dark:bg-dark border border-slate-200 dark:border-dark-border/10 rounded-2xl text-sm" placeholder="Perbarui ulasan Anda..."><?php echo e($userReview->comment); ?></textarea>
                            ...
                            <div class="flex items-start gap-5">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center justify-between gap-4 mb-2">
                                        <div>
                                            <h5 class="font-black text-[11px] text-slate-800 dark:text-white uppercase tracking-wider mb-1"><?php echo e($review->user->name); ?></h5>
                                            <div class="flex gap-0.5">
                                                <?php for($i=1;$i<=5;$i++): ?>
                                                <i class="fas fa-star text-[8px] <?php echo e($i <= $review->rating ? 'text-amber-400' : 'text-slate-200 dark:text-gray-800'); ?>"></i>
                                                <?php endfor; ?>
                                            </div>
                                        </div>
                                        <span class="text-[9px] font-bold text-slate-400 dark:text-gray-600 uppercase tracking-widest"><?php echo e($review->created_at->diffForHumans()); ?></span>
                                    </div>
                                    <?php if($review->comment): ?>
                                    <div class="relative mt-3">
                                        <i class="fas fa-quote-left absolute -left-2 -top-1 text-slate-100 dark:text-gray-800 text-xs opacity-50"></i>
                                        <p class="text-sm text-slate-600 dark:text-gray-400 leading-relaxed italic text-justify px-3"><?php echo e($review->comment); ?></p>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
            ...
            <div class="bg-white dark:bg-dark-card rounded-2xl shadow-sm dark:shadow-dark-soft border border-slate-100 dark:border-dark-border/20 p-8">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    ...
                    <a href="<?php echo e(route('user.books.show', $related)); ?>" class="group block">
                        <div class="aspect-[3/4] overflow-hidden rounded-xl mb-3 shadow-sm group-hover:shadow-xl transition-all group-hover:-translate-y-1">
                            <?php if($related->cover): ?>
                                <img src="<?php echo e(asset('storage/'.$related->cover)); ?>" alt="<?php echo e($related->title); ?>" class="w-full h-full object-cover">
                            <?php else: ?>
                        ...
                        <p class="text-[10px] font-black text-slate-800 dark:text-white uppercase tracking-tight line-clamp-2 leading-tight group-hover:text-primary-600 transition-colors"><?php echo e($related->title); ?></p>
                    </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\perpustakaan-digital\resources\views/user/books/show.blade.php ENDPATH**/ ?>