...
<body class="font-sans antialiased text-white min-h-screen flex items-center justify-center relative py-12 px-6">
    ...
    <div class="fixed inset-0 z-0 overflow-hidden">
        ...
        <img src="<?php echo e(asset('images/library-bg.png')); ?>" 
    ...
    <div class="relative z-20 w-full max-w-[800px]">
        <div class="glass-card rounded-[30px] p-8 md:p-12 text-center fade-in">
            ...
            <!-- Registration Form -->
            <form action="<?php echo e(route('register.post')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 text-left">
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" 
                               ...
                               class="input-glass w-full py-3.5 px-6 rounded-full text-slate-800 text-sm font-semibold placeholder-slate-400 focus:outline-none <?php $__errorArgs = ['name'];
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-[10px] text-red-200 mt-1 ml-4 font-bold italic"><?php echo e($message); ?></p><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="text" name="member_id" value="<?php echo e(old('member_id')); ?>" 
                               placeholder="Contoh: 12345" required
                               class="input-glass w-full py-3.5 px-6 rounded-full text-slate-800 text-sm font-semibold placeholder-slate-400 focus:outline-none <?php $__errorArgs = ['member_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" 
                               ...
                               class="input-glass w-full py-3.5 px-6 rounded-full text-slate-800 text-sm font-semibold placeholder-slate-400 focus:outline-none <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="tel" name="phone" value="<?php echo e(old('phone')); ?>" 
                               ...
                               class="input-glass w-full py-3.5 px-6 rounded-full text-slate-800 text-sm font-semibold placeholder-slate-400 focus:outline-none <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <select name="gender" required
                                class="input-glass w-full py-3.5 px-6 rounded-full text-slate-800 text-sm font-semibold placeholder-slate-400 focus:outline-none appearance-none <?php $__errorArgs = ['gender'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-400 <?php unset($message);
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative group">
                            <input type="password" id="password" name="password" 
                                   ...
                                   class="input-glass w-full py-3.5 px-6 pr-12 rounded-full text-slate-800 text-sm font-semibold placeholder-slate-400 focus:outline-none transition-all <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-1 md:col-span-2">
                        ...
                        <textarea name="address" rows="2" placeholder="Masukkan alamat lengkap Anda..." required
                                  class="input-glass w-full py-4 px-6 rounded-[20px] text-slate-800 text-sm font-semibold placeholder-slate-400 focus:outline-none resize-none <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- Login Link -->
            <div class="mt-10">
                <a href="<?php echo e(route('login')); ?>" class="text-white hover:text-[#00c6ff] font-medium text-sm transition-all italic border-b border-white/20 pb-1">
...
<?php /**PATH D:\perpustakaan-digital\resources\views/auth/register.blade.php ENDPATH**/ ?>