<?php $__env->startSection('title', 'Denda Layanan'); ?>
<?php $__env->startSection('page-title', 'Informasi Denda'); ?>
<?php $__env->startSection('page-subtitle', 'Pantau status kewajiban administrasi sirkulasi Anda'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="group relative bg-white p-8 rounded-2xl shadow-sm border border-slate-100 transition-all hover:shadow-xl hover:-translate-y-1 overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <h2 class="text-4xl font-black text-slate-900 tracking-tighter">Rp <?php echo e(number_format($totalFine, 0, ',', '.')); ?></h2>
            </div>
        </div>
        ...
        <div class="group relative bg-white p-8 rounded-2xl shadow-sm border border-slate-100 transition-all hover:shadow-xl hover:-translate-y-1 overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <h2 class="text-4xl font-black text-slate-900 tracking-tighter">Rp <?php echo e(number_format($potentialFine, 0, ',', '.')); ?></h2>
            </div>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-50 dark:divide-dark-border/10">
                    <?php $__empty_1 = true; $__currentLoopData = $fines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="group hover:bg-slate-50/50 dark:hover:bg-white/5 transition-colors">
                        <td class="px-8 py-5">
                            <span class="text-[10px] font-black text-slate-800 dark:text-white uppercase block leading-tight mb-0.5"><?php echo e($loan->book->title); ?></span>
                            <span class="text-[9px] text-slate-400 font-bold uppercase tracking-tighter"><?php echo e($loan->book->category->name); ?></span>
                        </td>
                        ...
                        <td class="px-8 py-5 text-center">
                            <a href="<?php echo e(route('user.loans.show', $loan)); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\perpustakaan-digital\resources\views/user/loans/fines.blade.php ENDPATH**/ ?>