...
<?php $__env->startSection('page-subtitle','Kelola kategori koleksi perpustakaan'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl p-5 shadow-sm border border-slate-100 hover:shadow-md transition-all duration-300 group">
        <div class="flex items-start justify-between mb-5">
            <div class="w-12 h-12 rounded-xl flex items-center justify-center shadow-inner" style="background:<?php echo e($cat->color); ?>20; border: 1px solid <?php echo e($cat->color); ?>30">
                <i class="fas fa-tag text-lg" style="color:<?php echo e($cat->color); ?>"></i>
            </div>
            <div class="flex gap-1.5">
                <button onclick="openEdit(<?php echo e($cat->id); ?>, '<?php echo e(addslashes($cat->name)); ?>', '<?php echo e(addslashes($cat->description ?? '')); ?>', '<?php echo e($cat->color); ?>')"
                ...
                <button type="button" 
                        onclick="openDeleteModal('<?php echo e(route('admin.categories.destroy', $cat)); ?>')"
        ...
        <h3 class="font-bold text-slate-800 mb-1.5 group-hover:text-emerald-600 transition-colors"><?php echo e($cat->name); ?></h3>
        <p class="text-slate-400 text-xs mb-4 line-clamp-2 min-h-[32px]"><?php echo e($cat->description ?: 'Tidak ada deskripsi'); ?></p>
        <div class="flex items-center justify-between pt-4 border-t border-slate-50">
            <span class="text-[10px] font-bold px-2.5 py-1 rounded-full ring-1 ring-inset" 
                  style="background:<?php echo e($cat->color); ?>20; color:<?php echo e($cat->color); ?>; ring-color:<?php echo e($cat->color); ?>40">
                <?php echo e($cat->books_count); ?> buku
            </span>
            <div class="w-3.5 h-3.5 rounded-full border-2 border-white shadow-sm" style="background:<?php echo e($cat->color); ?>"></div>
        </div>
    </div>
                ...
                <div>
                    ...
                    <div class="p-3 bg-slate-50 rounded-xl border border-slate-200">
                        ...
                        <div class="flex gap-2.5 flex-wrap">
                            <?php $__currentLoopData = ['#6366f1','#0ea5e9','#10b981','#f59e0b','#ec4899','#8b5cf6','#ef4444','#06b6d4','#1e293b','#fbbf24']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button type="button" onclick="document.querySelector('[name=color]').value='<?php echo e($c); ?>'" 
                                    class="w-7 h-7 rounded-full border-2 border-white shadow-sm hover:scale-110 active:scale-95 transition-all" 
                                    style="background:<?php echo e($c); ?>"></button>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\perpustakaan-digital\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>