...
<head>
    ...
    <style>
        .bg-library {
            background-image: url('<?php echo e(asset('images/library-bg.png')); ?>');
...
<body class="font-poppins h-screen w-screen overflow-hidden flex items-center justify-center text-white relative">
    ...
    <div class="relative z-10 text-center px-4 fade-in">
        ...
        <a href="<?php echo e(route('auth.selection')); ?>" class="btn-modern inline-block bg-blue-500 text-white font-semibold py-4 px-12 rounded-full text-lg tracking-widest uppercase cursor-pointer">
            Get In
        </a>
    </div>
...
<?php /**PATH D:\perpustakaan-digital\resources\views/landing.blade.php ENDPATH**/ ?>