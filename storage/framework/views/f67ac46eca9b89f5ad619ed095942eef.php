    ...
    <div class="relative z-20 w-full max-w-[420px]">
        <div class="glass-card rounded-[20px] p-10 text-center fade-in">
            ...
            <div class="flex justify-center mb-8">
                <div class="w-24 h-24 rounded-full bg-white flex items-center justify-center border-4 border-white/20 shadow-xl overflow-hidden">
                    <div class="flex flex-col items-center">
                        ...
                        <img src="<?php echo e(asset('storage/logo/pCwchhx4rSPGKHs7DyZjYSCMxjRBpMLn217MhNbY.png')); ?>"> <?php else: ?>
            ...
            <div class="mb-10">
                ...
                <p class="text-white font-medium text-sm"><?php echo e($appSettings['app_name'] ?? 'Perpustakaan.digital'); ?></p>
            </div>
            ...
            <form action="<?php echo e(route('login.post')); ?>" method="POST" class="space-y-4">
                ...
                <div class="flex justify-between px-4 text-[10px] font-medium text-white/50">
                    ...
                    <a href="<?php echo e(route('password.request')); ?>" class="hover:text-white transition-colors italic">Lupa sandi?</a>
                </div>
            ...
            <!-- Register Link -->
            <div class="mt-8">
                <a href="<?php echo e(route('register')); ?>" class="text-[#00c6ff] font-medium text-sm hover:underline italic">
...
</html><?php /**PATH D:\perpustakaan-digital\resources\views/auth/login.blade.php ENDPATH**/ ?>